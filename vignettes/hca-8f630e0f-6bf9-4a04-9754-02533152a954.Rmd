---
title: "Case Study: `r hcaCaseStudies::project_title('8f630e0f-6bf9-4a04-9754-02533152a954')`"
author:
  - name: Martin Morgan
    affiliation:
...
vignette: >
  %\VignetteIndexEntry{`r hcaCaseStudies::project_title('8f630e0f-6bf9-4a04-9754-02533152a954')`}
...
if (!cache_exists(project_id, object_name)) {
    files3 |>
        ...
        geo_count_matrix_gsms(reader_function = readr::read_csv) |>
