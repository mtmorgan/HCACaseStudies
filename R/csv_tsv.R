...
#'
#' @description `csv_tsv_gz_count_lines()` counts the number of lines
...
#'
#' @return `csv_tsv_gz_count_lines()` returns the original tibble
    ...
    function(.data, file_id = "fileId", file_path = "local.filePath")
{
    ...
    lines <- count_lines_in_gzfiles(.data, file_id, file_path)
